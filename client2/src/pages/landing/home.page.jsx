    ...
    return (<>
        ...
        <div class="container px-4 py-5" id="hanging-icons">
            ...
            <div class="col d-flex align-items-start">
                    <div class="icon-square rounded p-2 text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
                        <i class="fa-solid fa-store"></i>                    </div>
                    <div>
                        <h3 class="fs-2 text-body-emphasis">Farmers Market</h3>
                ...
                <div class="col d-flex align-items-start">
                    ...
                    <div>
                        <h3 class="fs-2  text-body-emphasis">Crop Recommendation</h3>
                ...
                <div class="col d-flex align-items-start">
                    ...
                    <div>
                        <h3 class="fs-2 text-body-emphasis">Crop Cure</h3>
                ...
                <div class="col d-flex align-items-start">
                    <div class="icon-square rounded p-2 text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
                        <i class="fa-solid fa-shop"></i>                    </div>
                    <div>
                        <h3 class="fs-2 text-body-emphasis">Sell your products</h3>
